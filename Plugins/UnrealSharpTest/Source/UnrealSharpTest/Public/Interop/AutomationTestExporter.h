 ...
 *
 * This class provides static methods for adding test cases, queuing latent commands, and logging automation test events.
 */
UCLASS()
...
public:
     ...
     */
    UNREALSHARP_FUNCTION()
    static void AddExpectedMessage(const TCHAR* ExpectedPattern, ELogVerbosity::Type ExpectedVerbosity, EAutomationExpectedMessageFlags::MatchType MatchType, int32 Occurrences, bool IsRegex);
};
