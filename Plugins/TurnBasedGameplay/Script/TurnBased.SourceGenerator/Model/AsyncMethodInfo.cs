...
public record AsyncMethodInfo(string Namespace, 
                              string ClassName, 
                              string MethodName, 
...
{
    public ITypeSymbol? ReturnType => TaskType is INamedTypeSymbol { IsGenericType: true } genericTaskType ? genericTaskType.TypeArguments[0] : null;
