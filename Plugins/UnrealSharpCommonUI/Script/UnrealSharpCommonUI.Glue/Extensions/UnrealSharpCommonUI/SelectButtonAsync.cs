...
internal partial class USelectButtonAsync
{
    ...
    public static Task<OptionSelection> SelectButtonAsync(UCommonButtonGroupBase buttonGroup,
...
{
    public static Task<OptionSelection> SelectButtonAsync(this UCommonButtonGroupBase buttonGroup,
                                                          CancellationToken cancellationToken = default)
    {
