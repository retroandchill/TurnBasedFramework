...
public class ExpFormulaTest
{
    private static readonly Dictionary<FGameplayTag, ImmutableArray<int>> ExpGrowthCurve = new()
    {
        [GameplayTags.Pokemon_Data_GrowthRates_Medium] =
        [
            -1,
        ...
        [GameplayTags.Pokemon_Data_GrowthRates_Erratic] =
        [
            -1,
        ...
        [GameplayTags.Pokemon_Data_GrowthRates_Fluctuating] =
        [
            -1,
        ...
        [GameplayTags.Pokemon_Data_GrowthRates_Parabolic] =
        [
            -1,
        ...
        [GameplayTags.Pokemon_Data_GrowthRates_Fast] =
        [
            -1,
        ...
        [GameplayTags.Pokemon_Data_GrowthRates_Slow] =
        [
            -1,
    ...
    private ExpGrowthFormulaProvider _formulaProvider;

    [SetUp]
    public void SetUp()
    {
        var serviceCollection = new ServiceCollection();
        serviceCollection.AddSingleton<IExpGrowthFormula, ErraticExpGrowthFormula>()
        ...
        _formulaProvider = _serviceProvider.GetRequiredService<ExpGrowthFormulaProvider>();
    }
    ...
    private static readonly ImmutableArray<FGameplayTag> GrowthRateFormulas = [..ExpGrowthCurve.Keys];

    [Combinatorial]
    public void TestGetMinimumExpForLevel([ValueSource(nameof(GrowthRateFormulas))] FGameplayTag formula,
                                   [Values(1)]
                                   [DynamicRandom(2, 15)]
                                   [DynamicRandom(16, 35)]
                                   [DynamicRandom(36, 50)]
