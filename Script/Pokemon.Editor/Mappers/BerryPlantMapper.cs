...
{
    public static UBerryPlant ToBerryPlant(this BerryPlantInfo berryPlantInfo, UObject? outer = null)
    {
    ...
    private static partial BerryPlantInitializer ToBerryPlantInitializer(this BerryPlantInfo berryPlant, UObject? outer = null);
