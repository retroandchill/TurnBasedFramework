...
public static partial class ItemMapper
{
    ...
    [MapProperty(
        nameof(ItemInitializer.DisplayNamePortionPlural),
        nameof(ItemInfo.PortionDisplayNamePlural)
    )]
