...
{
    public static UEnvironment ToEnvironment(this EnvironmentInfo environmentInfo, UObject? outer = null)
    {
    ...
    private static partial EnvironmentInitializer ToEnvironmentInitializer(this EnvironmentInfo environment, UObject? outer = null);
}
