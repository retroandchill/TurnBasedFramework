...
{
    public static UBattleWeather ToBattleWeather(
        this BattleWeatherInfo growthRateInfo,
        UObject? outer = null
    )
    {
    ...
    private static partial BattleWeatherInitializer ToBattleWeatherInitializer(
        this BattleWeatherInfo growthRate,
        UObject? outer = null
    );
}
