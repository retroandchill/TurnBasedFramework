...
public sealed class TypeJsonSerializer(IConfigOptions<JsonSerializerOptions> jsonSerializerOptions)
    : IGameDataEntrySerializer<UType>
{
    ...
    public IEnumerable<UType> DeserializeData(string source, UObject outer)
    {
        return JsonSerializer
            .Deserialize<TypeInfo[]>(source, _jsonSerializerOptions)!
