...
public sealed class MoveJsonSerializer(IConfigOptions<JsonSerializerOptions> jsonSerializerOptions)
    : IGameDataEntrySerializer<UMove>
{
    ...
    public IEnumerable<UMove> DeserializeData(string source, UObject outer)
    {
        return JsonSerializer
            .Deserialize<MoveInfo[]>(source, _jsonSerializerOptions)!
