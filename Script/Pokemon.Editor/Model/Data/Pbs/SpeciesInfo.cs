...
public readonly record struct EvYield(
    [PbsScalar<MainStatConverter>] FGameplayTag Stat,
    [PbsRange<int>(1)] int Amount
);

public record struct LevelUpMoveInfo(
    [PbsRange<int>(0)] int Level,
...
public record SpeciesInfo
{
    ...
    public FGameplayTag GenderRatio { get; init; } =
        GameplayTags.Pokemon_Data_GenderRatios_Female50Percent;
    ...
    [GameplayTags.Pokemon_Data_EggGroups_Undiscovered];
